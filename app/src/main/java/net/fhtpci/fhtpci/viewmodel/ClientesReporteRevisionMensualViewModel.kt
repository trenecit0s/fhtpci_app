...
import net.fhtpci.fhtpci.repository.ClientesReporteRevisionMensualRepository
...
// VISTA MODELO PARA REPORTE DE REVISON DE EDXTINTORES MENSUAL POR CLIENTE

class ClientesReporteRevisionMensualViewModel : ViewModel() {
    private val repository = ClientesReporteRevisionMensualRepository()
    private val _clientesreporterevisionmensualList = MutableLiveData<List<ClientesReporteRevisionMensualResponse>?>()
    val clientesreporterevisionmensualList: LiveData<List<ClientesReporteRevisionMensualResponse>?> get() = _clientesreporterevisionmensualList

    fun fetchClientesReporteRevisionMensual() {
        viewModelScope.launch {
            val clientesreporterevisionmensual = repository.fetchClientesReporteRevisionMensual()
            _clientesreporterevisionmensualList.postValue(clientesreporterevisionmensual)
        }
    }
}