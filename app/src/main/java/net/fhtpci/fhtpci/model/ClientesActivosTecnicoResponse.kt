...
class ClientesActivosTecnicoResponse (
    val idClienteTecnico: Int,
    val nomClienteTecnico: String,
    val cveClienteTecnico: String,
    val rsocialClienteTecnico: String,
    val activoClienteTecnico: String,
    val obsClienteTecnico: String,
    val zonaClienteTecnico: Int,
    val emailClienteTecnico: String,
    val email2ClienteTecnico: String,
    val email3ClienteTecnico: String,
    val email4ClienteTecnico: String,
    val email5ClienteTecnico: String,
    val tecnico1ClienteTecnico: Int,
    val tecnico2ClienteTecnico: Int,
    val tecnico3ClienteTecnico: Int,
    val tecnico4ClienteTecnico: Int,
    val tecnico5ClienteTecnico: Int,
    val contactoClienteTecnico: String,
    val contacto2ClienteTecnico: String,
    val contacto3ClienteTecnico: String,
    val contacto4ClienteTecnico: String,
    val contacto5ClienteTecnico: String,
    val rep_01ClienteTecnico: String,
    val rep_02ClienteTecnico: String,
    val rep_03ClienteTecnico: String,
    val rep_04ClienteTecnico: String,
    val rep_05ClienteTecnico: String,
    val rep_06ClienteTecnico: String,
    val rep_07ClienteTecnico: String,
    val rep_08ClienteTecnico: String,
    val rep_09ClienteTecnico: String,
    val rep_10ClienteTecnico: String,
    val rep_11ClienteTecnico: String,
    val rep_12ClienteTecnico: String,
    val rep_13ClienteTecnico: String,
    val rep_14ClienteTecnico: String,
    val rep_15ClienteTecnico: String,
    val rep_16ClienteTecnico: String,
    val rep_17ClienteTecnico: String,
    val rep_18ClienteTecnico: String,
    val rep_19ClienteTecnico: String
)